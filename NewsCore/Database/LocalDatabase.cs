...
namespace NewsCore.Database
{
    public class LocalDatabase : IAsyncDisposable
    {
        private const string DbName = "NewsCoreDB.db3";
      ...
      //  private static readonly Lazy<string> DbPath = new Lazy<string>(() => Path.Combine(FileSystem.AppDataDirectory, DbName));
       // private static readonly string DbPath = Path.Combine(FileSystem.AppDataDirectory, DbName);
        ...
        public LocalDatabase()
        {
           ...
           // _connection = new SQLiteAsyncConnection(DbPath, SQLiteOpenFlags.ReadWrite | SQLiteOpenFlags.SharedCache);
        }
